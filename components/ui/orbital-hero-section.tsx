...
export function OrbitalHeroSection({
  ...
  useEffect(() => {
    ...
    function render(t: number) {
      ...
      ctx!.save();
      ctx!.beginPath();
      ctx!.rect(6, 6, Math.max(0, width - 12), Math.max(0, height - 12));
      ctx!.clip();
  ...
  return (
    ...
    >
      <canvas
        ...
        style={{
          maskImage: "radial-gradient(ellipse 80% 80% at center, rgba(0,0,0,1) 50%, rgba(0,0,0,0) 95%)",
          WebkitMaskImage: "radial-gradient(ellipse 80% 80% at center, rgba(0,0,0,1) 50%, rgba(0,0,0,0) 95%)",
        }}
      />
