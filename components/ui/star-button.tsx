...
export function StarButton({
  ...
  return (
    <button
      ...
      ref={pathRef}
      className={`relative z-[3] overflow-hidden h-14 px-8 py-4 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-lg font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 group/star-button bg-[#030014] border border-white/10 ${className || ""}`}
      {...props}
    >
      <div
